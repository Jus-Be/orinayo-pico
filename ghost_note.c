...
static uint8_t velocity_table[] = {
    0x20,  // track  0 - Kick
    0x25,  // track  1 - Snare
    0x30,  // track  2 - Hi-hat closed
    0x20,  // track  3 - Low floor tom
    0x20,  // track  4 - Low Tom
    0x30,  // track  5 - Hi-hat open
    0x20,  // track  6 - Hi mid tom
    0x20,  // track  7 - crash cymbal
    0x20,  // track  8 - ride cymbal
    0x20,  // track  9 - vibraslap
    0x25,  // track 10 - Hi bongo
    0x25,  // track 11 - Low bongo
    0x25,  // track 12 - Mute conga
    0x25   // track 13 - Low conga	
};
